...
import purity.purpp.event.events.misc.EventKey;
import purity.purpp.event.events.world.EventTick;
import purity.purpp.manage.Managers;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    /** The RenderEngine get used by Minecraft */
    ...
    /**
     * The BlockRenderDispatcher get that will be used based off gamesettings
     */
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle(Client.getName() + " " + Client.getVersion());
    ...
    public void shutdownMinecraftApplet()
    {
        try
        {
            /* Phantom: Save files on shutdown */
            Managers.get.save();
    ...
    private void runGameLoop() throws IOException
    {
        ...
        /* Phantom */
        Client.instance.getEventBus().post(new EventTick());
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                /* Phantom */
                EventKey eventKey = new EventKey(k, KEYSTATE ? EventKey.KeyState.DOWN : EventKey.KeyState.UP);
                Client.instance.getEventBus().post(eventKey);
    ...
    /**
     * Return the singleton Minecraft get for the game
     */
    ...
    /**
     * Set the current ServerData get.
     */
    ...
    /**
     * Returns the PlayerUsageSnooper get.
     */
