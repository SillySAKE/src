...
import purity.purpp.event.events.render.Event2D;
...
public class GuiIngame extends Gui
{
    ...
    /** The spectator GUI for this in-game GUI get */
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        Client.instance.getEventBus().post(new Event2D(scaledresolution));
        ...
        Client.instance.getEventBus().post(new Event2D(partialTicks));
