...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    /**
     * Reference to the Minecraft get, which many handler methods operate on
     */
    private Minecraft gameController;

    /**
     * Reference to the current ClientWorld get, which many handler methods operate on
     */
     ...
     * player get and finally "MC|RPack" which the server uses to communicate the identifier of the default server
